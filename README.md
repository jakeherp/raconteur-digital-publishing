...
1.  **Open the source code and start editing!**
    ...
    Open the `raconteur-reports` directory in your code editor of choice and edit `src/pages/index.tsx`. Save your changes and the browser will update in real time!
